...
repo --name="RHEL - os"       --baseurl http://linuxsoft.cern.ch/cdn.redhat.com/content/dist/rhel/server/5/5Server/x86_64/os
...
part /     --size=5120  --fstype ext3 --ondisk vda
part /var  --size=5120  --fstype ext3 --ondisk vda
part /tmp  --size=5120  --fstype ext3 --ondisk vda
